...
- Methods are provided to help determine sparsity patterns, sparse Jacobians can be updated efficiently with SparseMatrixColorings/DifferentiationInterface (using graph coloring), and the sparsity structure is passed to the solvers.
